...
flist = ['2', '3', '4', '5', '6', '7', '8', '9', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z']
...
with open("beijing.trainfile", 'w') as f:
    for this_file in flist:

        rootdir = os.path.join(r"C:\Users\cooper\Desktop\opp\beijing\p", this_file)
        print rootdir
