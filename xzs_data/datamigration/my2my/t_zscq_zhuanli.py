...
if __name__ == '__main__':
    ...
    row_list = [
        "t_zhuanlixinxi_id",
        "t_zhuanlixinxi_leixing",
        "t_zhuanlixinxi_shenqinghao",
        "t_zhuanlixinxi_faburiqi",
        "t_zhuanlixinxi_mingcheng",
        "t_zhuanlixinxi_shenqingren",
        "t_zhuanlixinxi_gongsi_id"
    ]

    table_sour = "t_zscq_zhuanlixinxi"
    ...
    while biao <=13000000:
        ...
        biao += 100000
        select_condition = "where t_zhuanlixinxi_id > %s and t_zhuanlixinxi_id <= %s" % (biaoshang, biao)
        biaoshang = biao
        # select_condition = ""
