...
if __name__ == '__main__':
    ...
    for enu, every in enumerate(datalist):
        ...
        L = (2001, u'\u970d\u5dde\u5e02\u8f9b\u7f6e\u519c\u6751\u4fe1\u7528\u5408\u4f5c\u793e\u5317\u6751\u5206\u793e', '', '', '', '', u'1426031600306', "2014-01-06", u'\u6ce8\u9500', u'\u96c6\u4f53\u5206\u652f\u673a\u6784(\u975e\u6cd5\u4eba)', "2014-1-6", u'\u674e\u6587\u5e73', u'2006-06-26\u20142008-03-15', u'5\u4e07\u5143\u4eba\u6c11\u5e01', "2014-1-6", u'\u5c71\u897f\u7701\u970d\u5dde\u5e02\u5de5\u5546\u884c\u653f\u7ba1\u7406\u5c40', u'\u970d\u5dde\u5e02\u8f9b\u7f6e\u9547\u5317\u6751', '', u'*\u519c\u6751\u50a8\u84c4\u5b58\u6b3e\u3001\u519c\u6237\u3001\u4e2a\u4f53\u7ecf\u6d4e\u6237\u3001\u519c\u6751\u5408\u4f5c\u7ecf\u6d4e\u3001\u7ec4\u7ec7\u53ca\u4f01\u4e8b\u4e1a\u5355\u4f4d\u7684\u5b58\u6b3e\u3001\u8d37\u6b3e\u53ca\u7ed3\u7b97\u3001\u7ecf\u4e2d\u56fd\u4eba\u6c11\u94f6\u884c\u6279\u51c6\u7684\u5176\u5b83\u4e1a\u52a1', '', '', '', '', '')

        cursor_targ.execute(sql, L)
        conn_targ.commit()
        print 'ok'
        break
        ...
        # every[7] = every[7].strftime("%Y-%m-%d")
        # every[10] = every[10].strftime("%Y-%m-%d")
        # every[14] = every[14].strftime("%Y-%m-%d")
